...
import com.example.composeapicall.ui.theme.ComposeAPICallTheme
import com.example.composeapicall.ui.theme.Purple500
import com.example.composeapicall.utils.Resource
import com.example.composeapicall.view.PostListCall
import com.example.composeapicall.viewmodel.UserViewModel
                ...
                if (viewModel.getUserData.value!!.isNotEmpty()) {
                    LazyColumn(
                        ...
                        items(getAllUserData.value!!.size) { index ->
                            PostListCall(getAllUserData.value!![index])
                        }
                    }
                }
            }
